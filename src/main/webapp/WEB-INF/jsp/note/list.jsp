...
<body>
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="<%= request.getContextPath() %>/notes/new" class="btn btn-primary">Saisir des Notes</a>
        </div>
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                ...
                %>
                    <tr>
                        <td class="align-middle bg-light"><strong><%= entry.getKey() %></strong></td>
                        <td>
                            <table class="table table-sm table-borderless mb-0">
                                ...
                                %>
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="<%= request.getContextPath() %>/notes/edit/<%= n.getId() %>" class="btn btn-sm btn-warning">Éditer</a>
                                            <a href="<%= request.getContextPath() %>/notes/delete/<%= n.getId() %>" class="btn btn-sm btn-danger px-2" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette note ?');">X</a>
                                        </td>
                                    </tr>
                                <%
                                        }
