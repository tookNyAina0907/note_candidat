...
<body>
    <div class="container mt-5">
        <h2 class="mb-4">Calcul de la Note Finale</h2>
        <p class="text-muted">Sélectionnez un candidat et une matière pour calculer la note finale en fonction des notes des correcteurs et des paramètres définis.</p>
        ...
        <% if (finalNote != null) { %>
            <div class="card border-success shadow">
                <div class="card-body text-center">
                    <h3 class="card-title text-success mb-3">Résultat du Calcul</h3>
                    <div class="display-4 fw-bold text-success"><%= String.format("%.2f", finalNote) %></div>
                    <p class="card-text mt-3 text-muted">Note finale après application des règles et résolutions.</p>
                </div>
            </div>
        <% } %>
