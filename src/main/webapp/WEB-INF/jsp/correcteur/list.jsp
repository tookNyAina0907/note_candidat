                    ...
                    <body>
                        <div class="container mt-5">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <a href="<%= request.getContextPath() %>/correcteurs/new"
                                ...
                                <tbody>
                                    <% if (correcteurs !=null) { for (Correcteur c : correcteurs) { %>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<%= request.getContextPath() %>/correcteurs/edit/<%= c.getId() %>"
                                                    class="btn btn-sm btn-warning">Éditer</a>
                                                <a href="<%= request.getContextPath() %>/correcteurs/delete/<%= c.getId() %>"
