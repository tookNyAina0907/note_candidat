<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ page import="com.example.model.Resolution" %>
        <% Resolution resolution=(Resolution) request.getAttribute("resolution"); String title=(resolution !=null &&
            resolution.getId() !=null) ? "Modifier une Résolution" : "Ajouter une Résolution" ; %>
            <!DOCTYPE html>
            <html lang="fr">
                            ...
                            <% } %>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nom" name="nom"
                                        value="<%= resolution != null && resolution.getNom() != null ? resolution.getNom() : "" %>"
                                        required>
                                </div>
