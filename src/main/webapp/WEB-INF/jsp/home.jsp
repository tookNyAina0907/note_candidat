            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <a href="<%= request.getContextPath() %>/candidats" class="btn btn-primary w-100">Voir les Candidats</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <a href="<%= request.getContextPath() %>/matieres" class="btn btn-primary w-100">Voir les Matières</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <a href="<%= request.getContextPath() %>/correcteurs" class="btn btn-primary w-100">Voir les Correcteurs</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <a href="<%= request.getContextPath() %>/operateurs" class="btn btn-primary w-100">Voir les Opérateurs</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <a href="<%= request.getContextPath() %>/resolutions" class="btn btn-primary w-100">Voir les Résolutions</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <a href="<%= request.getContextPath() %>/parametres" class="btn btn-primary w-100">Voir les Paramètres</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 mt-4">
                <div class="card h-100 shadow border-primary">
                    <div class="card-body">
                        ...
                        <a href="<%= request.getContextPath() %>/notes" class="btn btn-primary text-white w-100">Gérer les Notes</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 mt-4">
                <div class="card h-100 shadow border-success">
                    <div class="card-body">
                        ...
                        <a href="<%= request.getContextPath() %>/notes/final" class="btn btn-success text-white w-100">Voir la Note Finale</a>
                    </div>
                </div>
            </div>
        </div>
